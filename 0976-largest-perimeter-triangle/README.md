<h2><a href="https://leetcode.com/problems/largest-perimeter-triangle/?envType=problem-list-v2&envId=n6n7m59t">976. Largest Perimeter Triangle</a></h2><h3>Easy</h3><hr><p>Given an integer array <code>nums</code>, return <em>the largest perimeter of a triangle with a non-zero area, formed from three of these lengths</em>. If it is impossible to form any triangle of a non-zero area, return <code>0</code>.</p>
